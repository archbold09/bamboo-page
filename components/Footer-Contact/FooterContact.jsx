    ...
    // <div className="sm-hidden">
      <div className="flex justify-end items-center navbarFooter z-50 mb-16">
        <ul>
          ...
          <li className="mr-6 my-3">
            <a className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1 px-3 rounded inline-flex items-center" target="blank" href="https://api.whatsapp.com/send?phone=3015320181">
